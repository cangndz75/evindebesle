...
export default function AdminNewArrivalsPage() {
  ...
  const handleMove = async (index: number, direction: 'up' | 'down') => {
    ...
    if (direction === 'down' && index === newArrivalItems.length - 1) return;

    const newItems = [...newArrivalItems];
              ...
              {searchResults.map((product) => (
                ...
                >
                  ...
                  <Button 
                    ...
                    disabled={newArrivalItems.some(item => item.productId === product.id)}
                  >
                        ...
                        <TableRow key={item.id}>
                           <TableCell className="w-[100px]">
                              <div className="flex flex-col items-center justify-center space-y-1 bg-gray-50 p-1 rounded-md">
                                 ...
                                 <button onClick={() => handleMove(idx, 'down')} disabled={idx === newArrivalItems.length - 1} className="hover:bg-gray-200 p-1 rounded disabled:opacity-30">
