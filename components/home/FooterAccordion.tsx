...
const footerSections = [
  {
    ...
    links: [
      ...
      { label: "Kumaşlarımız", href: "#" },
      { label: "Mağazalarımız", href: "#" },
      { label: "Atletler & Partnerler", href: "#" },
      { label: "İlk Müdahale", href: "#" },
      { label: "Dark Velvet+ Ödüller", href: "#" },
    ],
  },
  {
    ...
    links: [
      ...
      { label: "İçerik Üreticisi Ol", href: "#" },
    ],
  },
  {
    title: "Destek",
    links: [
      { label: "Kargo Politikaları", href: "#" },
      { label: "İade Politikası", href: "#" },
      { label: "Kullanım Koşulları", href: "#" },
      { label: "Gizlilik Politikası", href: "/privacy" },
      { label: "Siparişimi Takip Et", href: "#" },
      { label: "Hediye Kartı Bakiyesi", href: "#" },
    ],
  },
  {
    title: "Yasal",
    links: [
      ...
      { label: "Erişilebilirlik Bildirimi", href: "#" },
      { label: "Sahte Ürün Bildir", href: "#" },
      { label: "Erişilebilirlik", href: "#" },
      { label: "Kişisel Verilerimi Paylaşma", href: "#" },
    ],
  },
];
