...
export default function EditProductPage() {
  ...
  return (
    <div className="min-w-0 -mx-3 sm:mx-0">
      
      <div className="sticky top-14 md:top-0 z-50 bg-white border-b border-gray-200 px-3 sm:px-6 py-3 shadow-sm">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between max-w-7xl mx-auto">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <h1 className="text-lg sm:text-2xl font-bold text-gray-900 truncate">Ürün Düzenle</h1>
          </div>
